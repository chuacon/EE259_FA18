        ...
        :PROGRAM_BANK(d1, file_name) // CALL THE CONSTRUCTOR OF THE BASE CLASS
{
    ...
    if(d1 < 0 || d1 > 20 || d2< 0 || d2 >20)
    {
    	output_file <<"+++ P5_OUTPUT >>> INPUT ERROR" << endl
     				<<"+++ P5_OUTPUT >>> UNABLE TO CREATE MATRIX" << endl
           	       	<<"+++ P5_OUTPUT >>> EXITING PROGRAM" << endl
          	       	<< "+++ P5 END +++++++++++++++++++++++++++++++++++++++++++" << endl;
        return;
    }    
   	else
...
{
	output_file <<"+++ P5 START +++++++++++++++++++++++++++++++++++++++++" << endl
     			<<"+++ P5_OUTPUT >>> CONTENTS OF MATRIX IS:" << endl;
...
MATRIX::operator < (int b)
{
    ...
    {
        output_file <<"+++ P5 START +++++++++++++++++++++++++++++++++++++++++" << endl
          	      	<<"+++ P5_OUTPUT >>> OVERLOADED OPERATOR < RETURNING TRUE" << endl
          	      	<<"+++ P5 END +++++++++++++++++++++++++++++++++++++++++++" << endl;
        return 1;
    }
    else
    {
        output_file <<"+++ P5 START +++++++++++++++++++++++++++++++++++++++++" << endl
         	     	<<"+++ P5_OUTPUT >>> OVERLOADED OPERATOR < RETURNING FALSE" << endl
         	     	<<"+++ P5 END +++++++++++++++++++++++++++++++++++++++++++" << endl;
	 	return 0;
    }
}
...
MATRIX::operator = (MATRIX  a_matrix)
{
    ...
    else if( (dim1 == a_matrix.dim1) && (dim2 == a_matrix.dim2))
    {
        ...
        output_file <<"+++ P5 START +++++++++++++++++++++++++++++++++++++++++" << endl
         	     	<<"+++ P5_OUTPUT >>> OVERLOADED OPERATOR = COMPLETED" << endl
    				<<"+++ P5 END +++++++++++++++++++++++++++++++++++++++++++" << endl;
    }
    else{}
}
...
MATRIX::operator / (MATRIX a_matrix)
{
    ...
    else if( dim2 == inv_matrix.dim1)
    {
        ...
        output_file <<"+++ P5 START +++++++++++++++++++++++++++++++++++++++++" << endl
         	   		<<"+++ P5_OUTPUT >>> OVERLOADED OPERATOR / COMPLETED" << endl
         	     	<<"+++ P5_OUTPUT >>> THE RESULT OF X/Y OPERATION IS:" << endl;
